...
from detectron2.evaluation.cocoeval_mp import COCOevalMP as COCOeval
...
class V3DetEvaluator(DatasetEvaluator):
    """
    ...
    def __init__(
        ...
        *,
        ...
        with contextlib.redirect_stdout(io.StringIO()):
            ...
            self.resize_to_coco_size()  # APs, APm, APl follows COCO image sizes
    ...
    def resize_to_coco_size(self):
        for ann in self._coco_api.dataset['annotations']:
            image_id = ann['image_id']
            w = self._coco_api.imgs[image_id]['width']
            h = self._coco_api.imgs[image_id]['height']
            ann['area'] = ann['bbox'][2] * ann['bbox'][3] / (w * h) * 275929  # coco image mean size:275929
