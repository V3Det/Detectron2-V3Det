...
from detic.evaluation.coco_evaluation import COCOEvaluator
from detic.evaluation.custom_coco_eval import CustomCOCOEvaluator
from detic.evaluation.custom_v3det_eval import CustomV3DetEvaluator
from detic.evaluation.evaluator import inference_on_dataset
