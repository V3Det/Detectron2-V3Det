...
_PREDEFINED_SPLITS_COCO = {
    ...
    "coco_zeroshot_train_oriorder_thr_0.8": ("coco/train2017", "custom_anns/instances_train2017_seen_2_oriorder_thr_0.8.json", 'all'),
    "coco_train_novel_cats": ("coco/train2017", "coco/zero-shot/instances_train2017_novel_cats.json", 'unseen'),
}
